...
2. **Đầu ra — các mục trong Proposal**
   ...
   - **Cost:** 0 VNĐ tiền mặt nhờ công cụ AI hỗ trợ free tier (Codex, Gemini CLI, Copilot), Azure for Students, subdomain miễn phí và tài liệu thử nghiệm có sẵn; công sức sinh viên được quản lý bằng giờ-người.
