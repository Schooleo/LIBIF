# PROJECT PROPOSAL
## CircleLibrary — Hệ thống Số hóa Thư viện Thông minh
...
**CircleLibrary** được đề xuất để thay thế toàn bộ vòng lặp thủ công đó: tự động hóa OCR, tập trung hóa kho tài liệu số, và trao cho sinh viên khả năng tự tra cứu — bảo mật, tức thì, 24/7.
...
### 2.3 Tại sao Bây giờ, Tại sao CircleLibrary
...
2. **Chi phí triển khai đã giảm đến mức khả thi với ngân sách giáo dục.** Hạ tầng cloud tối thiểu để vận hành một hệ thống như CircleLibrary nay chỉ tốn **~1.200.000 – 2.000.000 VNĐ/tháng** — tương đương chi phí in ấn vật phẩm truyền thông hằng tháng của một khoa trung bình.
...
| Vấn đề | Google Drive / Email | CircleLibrary |
|---|---|---|
...
Dự án chỉ thành công khi **cả ba nhóm cốt lõi** đều được thỏa mãn đồng thời:
...
Để đảm bảo dự án không chỉ là một ý tưởng trên giấy, nhóm phát triển đã tiến hành đánh giá tính khả thi trên 3 khía cạnh cốt lõi:
...
* **Chi phí phát triển tối ưu:** Với quy mô đội ngũ 4 nhân sự là sinh viên năm cuối khoa CNTT kết hợp các trợ lý lập trình AI (GitHub Copilot), tổng ngân sách phát triển MVP chỉ khoảng **62.500.000 VNĐ** (chi phí một lần duy nhất).
* **Chi phí vận hành siêu rẻ:** Chi phí hạ tầng cloud thực tế chỉ khoảng **2.370.000 VNĐ/tháng** (khoảng **28.440.000 VNĐ/năm**).
* **Tỷ suất hoàn vốn (ROI) rõ ràng:** Quy trình thủ công hiện tại làm lãng phí khoảng 46 ngày làm việc của thủ thư mỗi năm (tương đương khoảng 15-20 triệu VNĐ tiền lương lãng phí) và gây chậm trễ hàng ngàn giờ học tập của sinh viên. CircleLibrary giúp tiết kiệm 70% thời gian của thủ thư và loại bỏ hoàn toàn thời gian chờ đợi của sinh viên, mang lại giá trị kinh tế lớn hơn nhiều so với chi phí vận hành.
...
Khi xem xét tính khả thi của việc tự xây dựng CircleLibrary, chúng tôi đã đặt lên bàn cân so sánh với việc kết hợp các công cụ sẵn có trên thị trường nhằm tối ưu hóa chi phí:

| Tiêu chí | CircleLibrary (Tự phát triển) | Phương án 1: Nextcloud + Collabora + Elasticsearch | Phương án 2: Paperless-ngx + Directus + PDF.js | Phương án 3: Google Drive Restricted + Apps Script |
| :--- | :--- | :--- | :--- | :--- |
...
**Kết luận:** Mặc dù các phương án kết hợp (đặc biệt là Google Drive + Apps Script) có chi phí ban đầu bằng 0, chúng lại bộc lộ điểm yếu lớn về khả năng **bảo mật DRM** (dễ bị sinh viên bypass để tải file gốc) và **trải nghiệm người dùng** rời rạc. Việc đầu tư xây dựng CircleLibrary là phương án tối ưu nhất để đảm bảo cân bằng giữa tính bảo mật bản quyền, chất lượng OCR tiếng Việt và tính dễ dàng trong vận hành của thủ thư khoa.
...
### 5.2 Gantt Chart Điều chỉnh (4 Nhân sự)
...
Backend & OCR Dev               │     │     │     │     │     │     │     │     │
  Hỗ trợ thiết kế API & DB      │█████│█████│     │     │     │     │     │     │
  Thiết lập OCR Worker Pipeline │     │░░░░░│█████│█████│     │     │     │     │
  Full-text Search Indexing     │     │     │     │█████│█████│     │     │     │
  Hỗ trợ UAT & Sửa lỗi (Fixes)  │     │     │     │     │     │░░░░░│█████│█████│
Frontend Dev                    │     │     │     │     │     │     │     │     │
  Giao diện Catalog & Admin     │     │█████│█████│█████│     │     │     │     │
  Giao diện Reader Portal       │     │     │     │░░░░░│█████│█████│     │     │
  Giao diện Dashboard           │     │     │     │     │     │█████│█████│     │
  Sửa lỗi UI/UX sau UAT         │     │     │     │     │     │     │░░░░░│█████│
QA / Tester                     │     │     │     │     │     │     │     │     │
  Viết Test Plan & Test Case    │     │     │█████│█████│     │     │     │     │
  Kiểm thử chức năng & Tích hợp │     │     │     │     │█████│█████│     │     │
  Đánh giá OCR Accuracy         │     │     │     │     │░░░░░│█████│     │     │
  Tổ chức UAT & Kiểm thử Security│    │     │     │     │     │░░░░░│█████│█████│
...
| **M2** — OCR & Search | 5 | Pipeline VietOCR tự động hoàn thành; Tìm kiếm toàn văn (Full-text) hoạt động | PM + Backend Dev |
...
Để tối ưu hóa chi phí và phù hợp với thực tế triển khai của một dự án sinh viên cấp Khoa/Trường, cơ cấu nhân sự được thiết kế tinh gọn gồm **4 thành viên**, gộp các vai trò có tính chất bổ trợ để tập trung tối đa nguồn lực vào phát triển trực tiếp.

### 6.1 Ngân sách Phát triển (One-time Development Budget)

Ngân sách này được phân bổ cho 8 tuần xây dựng MVP bởi đội ngũ 4 thành viên (sinh viên năm cuối khoa CNTT - HCMUS) kết hợp công cụ AI trợ giúp:

**1. Nhân sự (8 tuần phát triển):**

| Vai trò | Số lượng | Mức hỗ trợ / tháng | Tổng cộng (8 tuần / 2 tháng) | Mô tả công việc |
|---|---|---|---|---|
| PM / Fullstack / DevOps (Lead) | 1 | 9.000.000 VNĐ | **18.000.000 VNĐ** | Lập kế hoạch, quản lý tiến độ, thiết lập CI/CD, thiết kế database, phát triển core API và hỗ trợ tích hợp |
| Backend & OCR Engineer | 1 | 7.500.000 VNĐ | **15.000.000 VNĐ** | Thiết lập OCR Pipeline (VietOCR/PaddleOCR), tối ưu hóa tốc độ nhận diện, lưu trữ S3, lập chỉ mục Full-text Search |
| Frontend Engineer | 1 | 7.500.000 VNĐ | **15.000.000 VNĐ** | Xây dựng giao diện Web App (Librarian Portal & Reader Portal), tối ưu hóa trải nghiệm đọc PDF bảo mật trên Canvas |
| QA / Tester | 1 | 5.000.000 VNĐ | **10.000.000 VNĐ** | Viết test case, kiểm thử tích hợp hệ thống, kiểm thử độ chính xác OCR, hỗ trợ UAT và chuẩn hóa dữ liệu |
| **Cộng nhân sự** | **4** | | **58.000.000 VNĐ** | |

**2. Công cụ & Hạ tầng phục vụ phát triển:**

| Hạng mục | Giải pháp | Tính toán | Tổng cộng (8 tuần) |
|---|---|---|---|
| Phí trợ lý AI | GitHub Copilot Pro | 250.000 VNĐ/tháng × 4 người × 2 tháng | **2.000.000 VNĐ** |
| Hạ tầng Dev Cloud | AWS EC2 & S3 (Spot Instances) | Tiết kiệm ~65% giá chạy thử nghiệm | **2.500.000 VNĐ** |
| **Cộng công cụ** | | | **4.500.000 VNĐ** |

**👉 Tổng ngân sách phát triển:** **62.500.000 VNĐ**
...
|---|---|---|
| Bản quyền AI vận hành | GitHub Copilot Pro (4 người × 250.000 VNĐ × 12 tháng) | **12.000.000 VNĐ** |
| Công tác bảo trì | Sửa lỗi, backup, hỗ trợ vận hành (10 giờ/tháng × 250.000 VNĐ/giờ) | **30.000.000 VNĐ** |

**👉 Tổng ngân sách vận hành năm đầu:** **70.440.000 VNĐ/năm**
...
*   Dự phòng phát triển: **9.375.000 VNĐ** (chỉ sử dụng khi kéo dài timeline phát triển).
*   Dự phòng vận hành: **10.566.000 VNĐ/năm** (dùng khi lượng sách số hóa vượt 50 GB dự kiến ban đầu hoặc lưu lượng OCR tăng cao).
...
CircleLibrary được tối ưu hóa đặc biệt cho **tiếng Việt và bối cảnh giáo dục Việt Nam** — điều mà các giải pháp quốc tế (KOHA, DSpace, Alma) không làm được mà không cần tùy chỉnh tốn kém. Đây là lợi thế khó sao chép nhanh: tích hợp VietOCR được tinh chỉnh, giao diện tiếng Việt native, và hiểu biết về quy trình thủ công đặc thù của thư viện trường đại học Việt Nam.

### 7.4 Phân tích Đối thủ Cạnh tranh (Competitor Analysis)

Để định vị rõ nét, CircleLibrary được so sánh với 3 nhóm giải pháp đối thủ hiện tại trên thị trường:

| Tiêu chí so sánh | Thư viện số truyền thống (Koha, DSpace, Vebrary) | Quản lý tài liệu doanh nghiệp (DocEye, Paperless-ngx) | Học liệu điện tử quốc tế (VitalSource, Kortext) | CircleLibrary (Đề xuất) |
| :--- | :--- | :--- | :--- | :--- |
...
CircleLibrary đi vào vùng ngách tối ưu: kết hợp **Tự động hóa OCR tiếng Việt + Bảo mật Canvas Reader chống tải file + Chi phí vận hành siêu rẻ (~2.3M/tháng)** cho cấp khoa.
